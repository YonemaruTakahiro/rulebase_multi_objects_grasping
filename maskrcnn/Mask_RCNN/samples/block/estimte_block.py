...
def estimate(ROOT_DIR, IMAGE_DIR, filename):
    ...
    sys.path.append(os.path.join(ROOT_DIR, "samples/block/"))

    # Directory to save logs and trained model
    MODEL_DIR = os.path.join(ROOT_DIR, "logs")

    # Path to Block trained weights
    # You can download this file from the Releases page
    # https://github.com/matterport/Mask_RCNN/releases
    BLOCK_WEIGHTS_PATH = os.path.join(ROOT_DIR, "mask_rcnn_block_0010.h5")
    print(BLOCK_WEIGHTS_PATH)

    config = block.BlockConfig()
    BLOCK_DIR = os.path.join(ROOT_DIR, "datasets/block")
    ...
    # Set path to block weights file

    # Download file from the Releases page and set its path
    # https://github.com/matterport/Mask_RCNN/releases
    weights_path = os.path.join(ROOT_DIR, "mask_rcnn_block_0010.h5")
...
if __name__ == '__main__':
    ...
    IMAGE_DIR = os.path.join(ROOT_DIR, "datasets/block/test")
    filename = '20200505172249.jpg'

...
def from_raw_to_lerobot_format(
    ...
    data_dict = load_from_raw(raw_dir, pkl_filename, videos_dir, fps, video, episodes, encoding)
...
def get_dataset(repo_id: str, root: str, raw_data_path: Path, pkl_filename:str, videos_dir: Path, fps: int,video=None, save=False, episodes=None,encoding=None)-> LeRobotDataset:
    ...
    hf_dataset, episode_data_index, info = from_raw_to_lerobot_format(raw_dir=raw_data_path,pkl_filename=pkl_filename, videos_dir=videos_dir,
                                                                      fps=fps, video=video, episodes=episodes,
                                                                      encoding=encoding)
...
if __name__=="__main__":
    ...
    pkl_filename="only_grouping.pkl"

    raw_data_path=Path("workspace/raw_data/teleop_expert/12_10")
    videos_dir=None
    fps = 10
    video=None
    episodes=None
    ...
    dataset=get_dataset(repo_id=repo_id,root=root,raw_data_path=raw_data_path,pkl_filename=pkl_filename,videos_dir=videos_dir,fps=fps,video=video,save=True,episodes=episodes,encoding=encoding)
